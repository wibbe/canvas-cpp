...
canvas->loadFile("...");
//canvas->loadCode("..."); We can just as well supply a string containing code.

Tt is only possible to call either @loadFile("...")@ or @loadCode("...")@ once. The second call to one of the functions will throw an assert.
